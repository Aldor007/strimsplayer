...
(function($, window, document, undefined){
    ...
    function player(element, options, pluginName){
        ...
        this.options = $.extend({
            width: 500,         // player width (integer or string)
            height: 400,            // player height (integer or string)
        ...
        if (!this.options.chromeless && this.options.showToolbar != true) this.options.showToolbar = 1;
